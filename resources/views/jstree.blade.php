                                ...
                                <section class="card card-blue-fill border-all-content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <table class="table-showInf" id="tab2-Info">
                                                    <tr>
                                                        <th><i class="fa fa-arrow-circle-right fa-1"></i> Group Name</th>
                                                        <td>
                                                            Head Office
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th><i class="fa fa-arrow-circle-right fa-1"></i> Ip Adress</th>
                                                        <td>
                                                            160.154.0.87
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th><i class="fa fa-arrow-circle-right fa-1"></i> System Description</th>
                                                        <td>
                                            ...
                                            <div class="col-md-5">
                                                <table class="table-showInf" id="tab2-Info">
                                                    <tr>
                                                        <th><i class="fa fa-arrow-circle-right fa-1"></i> Host Name</th>
                                                        <td>
                                            ...
                                            <div class="tabs-section-nav">
                                                <div class="tbl">
                                                    <ul class="nav" role="tablist">
                                                        <ol class="nav-item">
                                                            <a class="nav-link active" href="#tabs-2-tab-1" role="tab"
                                                        ...
                                                        <ol class="nav-item">
                                                            <a class="nav-link" href="#tabs-2-tab-2" role="tab"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                            <table class="table-editInf" id="tab2-Info">
                                                                ...
                                                                <tr>
                                                                    <th><i class="fa fa-arrow-circle-right fa-1"></i> SNMP Timeout</th>
                                                                    <td>
                                    ...
                                    <div class="card-block " style="margin-top: 50px">
                                        ...
                                        <section class="tabs-section">
                                            ...
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane fade in active show" id="tabs-3-tab-1" aria-expanded="true">
